...
public class Empresa {
	 ...
	 * <b>post: </b> Se inicializaron las 3 líneas telefónicas básicas y la línea
	 * celular.
	 */
	public Empresa() {
	 ...
	 * <b>post: </b> Se agrega la llamada local a la línea telefónica celular 1 si
	 * hay saldo local disponible en la línea
	 * 
	 * @param minutos
	 *            Número de minutos de la llamada. minutos > 0.
	 */
	 ...
	 * <b>post: </b> Se agrega la llamada a larga distancia a la línea telefónica
	 * VozIP 1 si hay saldo disponible en la línea para descontar los minutos.
	 * 
	 * @param minutos
	 *            Número de minutos de la llamada. minutos > 0.
	 */
	 ...
	 * <b>post: </b> Se agrega la llamada a celular a la línea telefónica VozIP 1 si
	 * hay saldo disponible en la línea para descontar los minutos.
	 * 
	 * @param minutos
	 *            Número de minutos de la llamada. minutos > 0.
	 */
	...
	/**
	 * Devuelve el nú8mero total de llamadas realizadas desde lineas telefónicas
	 * alternativas
	 * 
	...
	/**
	 * Devuelve el número total de llamadas realizadas desde lineas telefónicas
	 * alternativas
	 * 
	 * @return
	 */
	public int darTotalNumeroLlamadasDesdeLineasAlternativas() {
		return lineaCelular1.darNumeroLlamadas() + lineaVozIP1.darNumeroLlamadas();
	}
	...
	/**
	 * Devuelve el costo promedio de un minuto desde una línea alternativa, según
	 * los minutos consumidos <br>
	 * <b>pre: </b> TotalMinutos > 0
	 * 
	 * @return Costo promedio por minuto.
	 */
